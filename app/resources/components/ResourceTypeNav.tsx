...
import { BookOpen, Scale, FileText, Search, Layers, HelpCircle, FileCheck, Book } from "lucide-react";

export default function ResourceTypeNav() {
  const types = [
    { title: "Legal Glossary", subtitle: "Terms & Definitions", icon: <BookOpen size={28} strokeWidth={1.2} />, href: "/resources/glossary" },
