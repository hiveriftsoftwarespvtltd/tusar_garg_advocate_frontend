      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {types.map((type, idx) => (
          ...
          >
            ...
            <h3 className="text-[12.5px] font-bold text-[#0d1b3e] mb-1 leading-tight group-hover:text-[#c9a84c] transition-colors" style={{ fontFamily: "var(--font-merriweather), serif" }}>
              {type.title}
            </h3>
