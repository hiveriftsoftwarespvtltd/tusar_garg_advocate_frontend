    ...
    <section className="relative z-20 max-w-[1280px] mx-auto px-4 -mt-10 mb-8">
      <div className="bg-[#0d1b3e] rounded-xl border border-white/10 shadow-2xl overflow-hidden p-6 text-white">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 mb-6">
          ...
          {/* Types Tabs */}
          <div className="flex items-center gap-3 w-full lg:w-1/2 overflow-x-auto hide-scrollbar">
            {resourceTypes.map((type, idx) => (
              <button 
                key={idx} 
                className={`flex items-center gap-2 text-[11px] px-5 py-2.5 rounded-md transition-all whitespace-nowrap border ${
