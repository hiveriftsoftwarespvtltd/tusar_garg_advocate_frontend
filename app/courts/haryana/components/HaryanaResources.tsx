...
export default function HaryanaResources() {
  const resources = [
    {
    ...
    {
      title: "Judgments",
      desc: "Latest judgments from Haryana district courts across various practice areas.",
      ...
      <div className="max-w-[1280px] mx-auto px-4">
        ...
        <div className="text-center mb-10 flex flex-col items-center">
          <h2 className="text-[20px] md:text-[24px] font-serif font-bold text-[#0d1b3e] mb-3 uppercase tracking-wider">
            LEGAL RESOURCES FOR HARYANA COURTS
          </h2>
