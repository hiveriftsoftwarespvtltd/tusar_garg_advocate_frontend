...
export default function DelhiResources() {
  const resources = [
    {
    ...
    {
      title: "Judgments",
      desc: "Latest judgments from Delhi courts across various practice areas.",
      icon: <Gavel size={42} strokeWidth={1.5} />,
      link: "#"
    },
    {
      title: "Court Directory",
      desc: "Addresses, contact details and useful information for all Delhi court complexes.",
      ...
      <div className="max-w-[1280px] mx-auto px-4">
        ...
        <div className="text-center mb-10 flex flex-col items-center">
          <h2 className="text-[20px] md:text-[24px] font-serif font-bold text-[#0d1b3e] mb-3 uppercase tracking-wider">
            LEGAL RESOURCES FOR DELHI COURTS
          </h2>
          <div className="w-12 h-[2px] bg-[#c9a84c]"></div>
        </div>

        {/* Resources Container - Single block with dividers */}
