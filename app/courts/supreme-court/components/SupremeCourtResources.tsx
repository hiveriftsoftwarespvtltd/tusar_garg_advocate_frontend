...
export default function SupremeCourtResources() {
  const resources = [
    {
      title: "Court Procedures",
      desc: "Step-by-step guidance on filing SLPs, Writ Petitions, and processes.",
      icon: <Landmark size={42} strokeWidth={1.5} />,
      link: "#"
    },
    {
      title: "Important Acts & Laws",
      desc: "Key laws and constitutional provisions applicable in the Supreme Court.",
      icon: <BookOpen size={42} strokeWidth={1.5} />,
      link: "#"
    },
    {
      title: "Landmark Judgments",
      desc: "Latest and landmark judgments from the Supreme Court of India.",
      icon: <Gavel size={42} strokeWidth={1.5} />,
      link: "#"
    },
    {
      title: "Court Directory",
      desc: "Addresses, contact details and useful information for the Apex Court.",
      ...
      <div className="max-w-[1280px] mx-auto px-4">
        ...
        <div className="text-center mb-10 flex flex-col items-center">
          <h2 className="text-[20px] md:text-[24px] font-serif font-bold text-[#0d1b3e] mb-3 uppercase tracking-wider">
            LEGAL RESOURCES FOR SUPREME COURT
          </h2>
