...
export default function SupremeCourtHero() {
  return (
    <section className="relative w-full h-[450px] lg:h-[500px] flex items-center bg-[#0d1b3e]">
      ...
      <div className="max-w-[1280px] mx-auto w-full px-4 relative z-10 flex flex-col items-start mt-10">
        ...
        <nav className="flex items-center gap-2 text-[12px] md:text-[13px] font-medium text-white/80 mb-6 tracking-wide">
          ...
          <ChevronRight size={14} className="opacity-70" />
          <span className="text-white">Supreme Court</span>
        </nav>

        <h1 className="text-[36px] md:text-[50px] font-serif text-white mb-3 tracking-tight leading-tight" style={{ textShadow: "0 2px 10px rgba(0,0,0,0.3)" }}>
          SUPREME COURT OF INDIA
        </h1>

        <h2 className="text-[18px] md:text-[22px] font-semibold text-[#c9a84c] mb-5 max-w-xl leading-snug">
          Expert Legal Counsel & Representation<br className="hidden md:block" /> Before the Apex Court
        </h2>

        <p className="text-[14px] md:text-[15px] text-white/90 max-w-[450px] leading-relaxed mb-8">
          With specialized experience as an Advocate-on-Record, we provide strategic and result-oriented legal representation in the Supreme Court of India.
        </p>
